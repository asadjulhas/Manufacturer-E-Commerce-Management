...
const Profile = () => {
  ...
  const {data, isLoading, refetch} = useQuery(['user'], () => fetch(`https://manufacturer.asadjulhas.com/user/${lgUser.email}`, {
    headers: {
  ...
  const handleUpdateProfile = (e) => {
    ...
    axios.post("https://manufacturer.asadjulhas.com/update-profile", data, {
      headers: {
        'authorization': `Bearer ${accessToken}`
      }
    }).then((res) => {
